...
if (isset($_POST['motel_id']) && !empty($_POST['motel_id'])) {
    $user_id= $_SESSION['key'];
    $motel_id = $_POST['motel_id'];
    $user= $motel->motelReadmore($motel_id);
     ?>
 <style>
    	ul{
                   ...
                   <div class="row reusercolor p-2">
                             ...
                             <div class="clearfix" style="max-width:474px;">
                                ...
                                <?php 
                                        ...
                                        for ($i=0; $i < count($expode); ++$i) { 
                                            ?>
                                            <li data-thumb="<?php echo BASE_URL_PUBLIC.'uploads/Rwandamotel/'.$expode [$i]; ?>"> 
                                                <img src="<?php echo BASE_URL_PUBLIC.'uploads/Rwandamotel/'.$expode [$i]; ?>" />
                                                </li>
                                      <?php } ?>
                                </ul>
                            </div>
                     ...
                     <div class="col-md-6">
                         <div class="row">
                             <div class="col-md-6">
                                     <ul class="list-group">
                                        <li class="list-group-item active"> How to get to motel </li>
                                        <li class="list-group-item "><i class="fa fa-plane" aria-hidden="true"></i> From kigali Airport to motel  </li>
                     ...
                     <div class="col-md-12 mt-3">
                      <div class="blog-post">
                        <h2 class="blog-post-title">About the motel</h2>

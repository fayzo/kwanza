...
if (isset($_POST['motel_view']) && !empty($_POST['motel_view'])) {
...
<div class="motel-popup">
    <div class="wrap6">
        ...
        <div class="img-popup-wrap">
            ...
            <div class="card">
                <span id="responseSubmitmotel"></span>
                <div class="card-header">
                    <h5 class="card-text">Rwanda motel</h5>
                    <p class="card-text">Do you want to add rwanda motel ? Please fill details below.</p>
                </div>
                <form method="post" id="form-motel"  enctype="multipart/form-data" >
                <div class="card-body">
                       ...
                       <div class="col">
                         ...
                         <div class="col">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="name of motel">
                          </div>
                        </div>
...
if (isset($_POST['user_id']) && !empty($_POST['user_id'])) {
    ...
    if (!empty($_FILES['video']['name'][0])) {
      $video= $_FILES['video'];
      $video_ = $home->uploadRwandamotelFile($video);
	...
	if (!empty($phone) || !empty(array_filter($photo['name'])) || !empty(array_filter($other_photo['name'])) ) {
		if (!empty($photo['name'][0])) {
			# code...
			$photo_ = $home->uploadRwandamotelFile($photo);
            $other_photo_ = $home->uploadRwandamotelFile($other_photo);
		}
	...
	$users->Postsjobscreates('rwandamotel',array( 
	'title_'=> $title,
	'author_'=> $author,
	'phone_'=> $phone,
	'price'=> $price,

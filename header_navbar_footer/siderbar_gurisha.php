        ...
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <?php if (isset($_SESSION['key'])) { ?>
            <button type="button" class="btn btn-light" id="add_gurisha" data-gurisha="<?php echo $_SESSION['key']; ?>" > + Add house </button>
           <?php } ?>
          </div>
          <div class="col-4 text-center">
            <a class="blog-header-logo text-dark" href="#">Gurisha</a>
          </div>

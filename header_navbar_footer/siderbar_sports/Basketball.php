  ...
  <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i>Basketball</i></h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Basketball</li>
                    <li class="breadcrumb-item"><button type="button" class="btn btn-light btn-sm" id="add_Basketball" data-Basketball="<?php echo $_SESSION['key']; ?>" > + Add Basketball </button></li>
    ...
    <div class="row">
        <div class="col-md-3">
            <?php echo $basketball->BasketballRecent_news('Basketball'); ?>
        </div><!-- col -->

        <div class="col-md-6">
           
            <div class="card">
                 <div id="Basketball-view">
                      <?php  
                      $date = strtotime("0 day"); 
                      echo $basketball->currentDateBasketballMatch(0,date('y-m-d', $date),date('Y-m-d', $date));
                      ?>
                </div>
            </div> <!-- card -->
        </div> <!-- col -->
        ...
        <div class="col-md-3">
          ...
          <div class="card-header text-center main-active">
              <div class="h5">Basketball Scores Tables</div>
          </div>
          <div class="card-body">

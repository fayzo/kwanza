  ...
  <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i>Volleyball</i></h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Volleyball</li>
                    <li class="breadcrumb-item"><button type="button" class="btn btn-light btn-sm" id="add_Volleyball" data-Volleyball="<?php echo $_SESSION['key']; ?>" > + Add Volleyball </button></li>
    ...
    <div class="row">
        <div class="col-md-3">
            <?php echo $volleyball->VolleyballRecent_news('Volleyball'); ?>
        </div><!-- col -->

        <div class="col-md-6">
           
            <div class="card">
                 <div id="Volleyball-view">
                      <?php  
                      $date = strtotime("0 day"); 
                      echo $volleyball->currentDateVolleyballMatch(0,date('y-m-d', $date),date('Y-m-d', $date));
                      ?>
                </div>
            </div> <!-- card -->
        </div> <!-- col -->
        ...
        <div class="col-md-3">
          ...
          <div class="card-header text-center main-active">
              <div class="h5">Volleyball Scores Tables</div>
          </div>
          <div class="card-body">

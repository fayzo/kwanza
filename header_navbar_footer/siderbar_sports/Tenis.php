  ...
  <section class="content-header">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><button type="button" class="btn btn-light btn-sm" id="add_Tenis" data-Tenis="<?php echo $_SESSION['key']; ?>" > + Add Tenis </button></li>
    ...
    <div class="row">
        <div class="col-md-3">
            <?php echo $tenis->TenisRecent_news('Tenis'); ?>
        </div><!-- col -->

        <div class="col-md-6">
           
            <div class="card">
                 <div id="Tenisball-view">
                      <?php  
                      $date = strtotime("0 day"); 
                      echo $tenis->currentDateTenisMatch(0,date('y-m-d', $date),date('Y-m-d', $date));
                      ?>
                </div>
            </div> <!-- card -->
        </div> <!-- col -->
        ...
        <div class="col-md-3">
          ...
          <div class="card-header text-center main-active">
              <div class="h5">Tenis Scores Tables</div>
          </div>
          <div class="card-body">
        ...
        <div class="card mb-3">
                ...
                <div class="card-body sportx">
                 <div style="background:#b9b6b22b;padding:7px;">
                        <span style="text-decoration:underline"> Tenis</span>
                   </div>
                    <div class="FOOT">

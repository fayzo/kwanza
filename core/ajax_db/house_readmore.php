            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <div class="row reusercolor p-2">
                       <div class="col-md-12">
                      <h5 class="text-center h4 mb-2"><?php echo $user['categories_house']." in ".$user['province']." Location ".$user['cell']."/".$user['sector']." at ".$user['price']." Frw"; ?></h5>
                                        ...
                                        for ($i=0; $i < count($splice); ++$i) { 
                                            ?>
                                             <div class="imagehouseViewPopup more"  data-house="<?php echo $user["house_id"] ;?>">
                                                <img data-u="image" src="<?php echo BASE_URL_PUBLIC."uploads/house/".$splice[$i] ;?>" />
               ...
               <?php if ($count === 1) { ?>
                       ...
                       <div class="mt-2">
                            <?php 
                               ...
                               $expode = explode("=",$file); ?>
                             <div class="imagehouseViewPopup more"  data-house="<?php echo $user["house_id"] ;?>">
                                <img src="<?php echo BASE_URL_PUBLIC."uploads/house/".$expode[0] ;?>"
                                    alt="Photo" >
                             </div>
                       </div>
                              ...
                              <h5 class="mt-3"> Comments</h5>
                                ...
                                <div class="input-group mt-2">
                                    <input class="form-control form-control-sm" id="commentHome" type="text"
                                        name="comment" data-house="<?php echo $user['house_id'];?>"

            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <div class="row reusercolor p-2">
                       <div class="col-md-12">
                      <h5 class="text-center h4 mb-2"><?php echo $user['photo_Title_main']." at ".$user['price']." Frw"; ?></h5>
                                        ...
                                        for ($i=0; $i < count($splice); ++$i) { 
                                            ?>
                                             <div class="imagefoodViewPopup more"  data-food="<?php echo $user["food_id"] ;?>">
                                                <img data-u="image" src="<?php echo BASE_URL_PUBLIC."uploads/food/".$splice[$i] ;?>" />
               ...
               <?php if ($count === 1) { ?>
                       ...
                       <div class="mt-2">
                            <?php 
                               ...
                               $expode = explode("=",$file); ?>
                             <div class="imagefoodViewPopup more"  data-food="<?php echo $user["food_id"] ;?>">
                                <img src="<?php echo BASE_URL_PUBLIC."uploads/food/".$expode[0] ;?>"
                                    alt="Photo" >
                             </div>
                       </div>
                              ...
                              <h5 class="mt-3"> Comments</h5>
                                ...
                                <div class="input-group mt-2">
                                    <input class="form-control form-control-sm" id="commentHome" type="text"
                                        name="comment" data-food="<?php echo $user['food_id'];?>"

...
if (isset($_POST['entertainment_id']) && !empty($_POST['entertainment_id'])) {
    $user_id= $_SESSION['key'];
    $entertainment_id = $_POST['entertainment_id'];
    $user= $entertainment->entertainmentReadmore($entertainment_id);
     ?>

<div class="entertainment-popup">
    <div class="wrap6">
        <span class="colose">
                                ...
                                <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:980px;overflow:hidden;"> <!--width:980px;height:380px -->
                                      <?php 
                                        ...
                                        for ($i=0; $i < count($splice); ++$i) { 
                                            ?>
                                      <div class="imageblogViewPopup more"  data-entertainment="<?php echo $user["entertainment_id"] ;?>">
                                      <img data-u="image" src="<?php echo BASE_URL_PUBLIC."uploads/entertainment/".$splice[$i] ;?>"
                                          alt="Photo" >
                                      </div>
                                      <?php } ?>
             ...
             if (array_diff($fileActualExt,$allower_ext) == false) {
               ...
               <?php if ($count === 1) { ?>
                       ...
                       <div class="mt-2">
                            <?php 
                               ...
                               $expode = explode("=",$file); ?>
                             <div class="imageblogViewPopup more"  data-entertainment="<?php echo $user["entertainment_id"] ;?>">
                                <img src="<?php echo BASE_URL_PUBLIC."uploads/entertainment/".$expode[0] ;?>"
                                    alt="Photo" >
                             </div>
               ...
               <?php }else if ($count === 2) { ?>
                         ...
                         <?php 
                               ...
                               for ($i=0; $i < count($splice); ++$i) { 
                                   ...
                                   <div class="mt-2">
                                         <div class="imageblogViewPopup more"  data-entertainment="<?php echo $user["entertainment_id"] ;?>">
                                         <img src="<?php echo BASE_URL_PUBLIC."uploads/entertainment/".$splice[$i] ;?>"
                                             alt="Photo" >
                                         </div>
               ...
               <?php }else if ($count === 3) { ?>
                  ...
                  <?php }else if ($count > 3) { ?>
                            ...
                            <span class="btn btn-primary imageblogViewPopup  float-right" data-entertainment="<?php echo $user["entertainment_id"] ;?>" > View More photo  <i class="fa fa-picture-o"></i> >>> </span>
                              ...
                              <h5 class="mt-3"> Comments</h5>
                                ...
                                <div class="input-group mt-2">
                                    <input class="form-control form-control-sm" id="commentHome" type="text"
                                        name="comment" data-entertainment="<?php echo $user['entertainment_id'];?>"

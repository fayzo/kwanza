                        ...
                        <div class="col">
                          ...
                          <div class="form-check">
                            <label class="form-check-label">
                              <input class="form-check-input" type="checkbox" name="photo" id="photo" value="images.jpg"> <img src="<?php echo BASE_URL_PUBLIC.'uploads/domesticsEmployers/images.jpg'; ?>" class="mt-3" with="100px" height="100px">
                            </label>
                            <label class="form-check-label ml-3">
                              <input class="form-check-input" type="checkbox" name="photo" id="photo" value="images.jpg" > <img src="<?php echo BASE_URL_PUBLIC.'uploads/domesticsEmployers/images1.jpg'; ?>" class="mt-3" with="100px" height="100px">
                            </label>
                            <label class="form-check-label ml-3">
